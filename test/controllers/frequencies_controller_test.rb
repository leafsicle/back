...
class FrequenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create frequency" do
    assert_difference('Frequency.count') do
      post frequencies_url, params: { frequency: { days: @frequency.days, duration: @frequency.duration } }
    end
  ...
  test "should update frequency" do
    patch frequency_url(@frequency), params: { frequency: { days: @frequency.days, duration: @frequency.duration } }
